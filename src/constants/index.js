...
const services = [
  ...
  {
    title: 'Goal-Oriented Individual',
    icon: creator,
  },
];
...
const projects = [
  {
    name: 'AI ChatBot App',
    description:
      'A clone of ChatGPT, web application built with the OpenAI API that allows users to ask the chatbot any questions.',
    tags: [
      {
        name: 'react',
    ...
    image: aichatbot,
    source_code_link: 'https://github.com/david-tech-ding/ai-chatbot',
  },
  {
    name: 'Task Manager',
    description:
